...
<!-- BEGIN Comments -->	
	...
	<div class="comment-holder">
		<h3 class="comments-h"><a href=""><?php printf(_n("View Response", "View All Responses", get_comments_number(), CURRENT_THEME ),
				number_format_i18n( get_comments_number() ), '' );?></a></h3>
